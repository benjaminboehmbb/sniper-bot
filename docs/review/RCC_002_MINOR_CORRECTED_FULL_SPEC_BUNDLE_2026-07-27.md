# RCC-002 Minor Corrected Full Specification Bundle
...
| `RCC_002_INDICATOR_SPECIFICATION_2026-07-23.md` | `0.4.2` | 1742 | 50958 | `58bbdbe9d0d0beda43f1fbec443814aa23a6deec5f2152371aa4ef1ac6bbdf9c` |
| `RCC_002_SIGNAL_TRANSFORMATION_2026-07-23.md` | `0.4.1` | 1665 | 53228 | `0a9c5f2d345add8cc2627e2771bfaea9f951ba8bb7484f1fa1d9c51b054ae81c` |
| `RCC_002_REGIME_AND_GATE_SPECIFICATION_2026-07-23.md` | `0.5.1` | 2216 | 68324 | `369ecc70b6f9a9cfad8fab8cc5e4f81412afc1706f1c9c0e6d99eda435f02f35` |
| `RCC_002_LABEL_AND_FORWARD_RETURN_SPECIFICATION_2026-07-23.md` | `0.4.1` | 2017 | 60288 | `81f48b30984944dc4218857167e508bb7ff0dc5fa541b607b110333e784bc7d0` |
| `RCC_002_REPRODUCIBILITY_AND_MANIFEST_2026-07-23.md` | `0.7.0` | 2245 | 76769 | `e2c866eb43bf082f25ec92ad3cc7767a9257efc5623f4fb8891d87eb5e904438` |
...
| Status | SCR-005-Corrected Draft – Scientific Consistency Re-Review 006 Pending |
| Übergeordnetes Dokument | `RCC_002_DATA_PIPELINE_SPECIFICATION_2026-07-23.md`, Version 0.7.1 |
| Direkte Abhängigkeiten | `RCC_002_DATA_VALIDATION_2026-07-23.md`, Version 0.4.2; `RCC_002_INDICATOR_SPECIFICATION_2026-07-23.md`, Version 0.4.2 |
...
| Status | SCR-005-Corrected Draft – Scientific Consistency Re-Review 006 Pending |
| Übergeordnetes Dokument | `RCC_002_DATA_PIPELINE_SPECIFICATION_2026-07-23.md`, Version 0.7.1 |
| Direkte Abhängigkeiten | `RCC_002_DATA_VALIDATION_2026-07-23.md`, Version 0.4.2; `RCC_002_INDICATOR_SPECIFICATION_2026-07-23.md`, Version 0.4.2; `RCC_002_SIGNAL_TRANSFORMATION_2026-07-23.md`, Version 0.4.1 |
...
| Status | SCR-005-Corrected Draft – Scientific Consistency Re-Review 006 Pending |
| Übergeordnetes Dokument | `RCC_002_DATA_PIPELINE_SPECIFICATION_2026-07-23.md`, Version 0.7.1 |
| Direkte Abhängigkeiten | `RCC_002_DATA_VALIDATION_2026-07-23.md`, Version 0.4.2; `RCC_002_INDICATOR_SPECIFICATION_2026-07-23.md`, Version 0.4.2; `RCC_002_SIGNAL_TRANSFORMATION_2026-07-23.md`, Version 0.4.1; `RCC_002_REGIME_AND_GATE_SPECIFICATION_2026-07-23.md`, Version 0.5.1 |
...
| Version | `0.7.0` |
| Datum | `2026-07-23` |
| Status | SCR-005-Corrected Draft – Scientific Consistency Re-Review 006 Pending; RCC-002-SCR-007 Full-Scope Replacement Scientific Consistency Review durchgeführt; Major- und Minor-Findings-Verifikation abgeschlossen; Minor Correction Cycle umgesetzt; Editorial Pass und Internal Certification ausstehend |
...
| Fachliche Abhängigkeiten | `RCC_002_DATA_VALIDATION_2026-07-23.md`, Version `0.4.2`; `RCC_002_INDICATOR_SPECIFICATION_2026-07-23.md`, Version `0.4.2`; `RCC_002_SIGNAL_TRANSFORMATION_2026-07-23.md`, Version `0.4.1`; `RCC_002_REGIME_AND_GATE_SPECIFICATION_2026-07-23.md`, Version `0.5.1`; `RCC_002_LABEL_AND_FORWARD_RETURN_SPECIFICATION_2026-07-23.md`, Version `0.4.1` |
...
umgesetzt; Full-Scope Replacement Architecture Integrity Review und
Editorial Pass ausstehend
```

Nächste vorgeschriebene Schritte:

1. Bundle- und Manifestregeneration gegen die sieben korrigierten
   Spezifikationen sowie unabhängige Hash- und Round-trip-Prüfung;
2. fokussierte Re-Review der in diesem Zyklus geänderten Textstellen;
3. Full-Scope Replacement Architecture Integrity Review;
4. Editorial Pass;
5. Internal Certification;
6. Claude Independent Architecture Review;
7. Gemini Independent Scientific and Adversarial Audit;
8. ChatGPT Final Consolidation;
9. `Baseline V1 Certified`;
10. Implementierungsfreigabe.
