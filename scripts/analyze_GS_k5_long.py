...
def main() -> int:
    ...
    if args.direction != "long":
        raise RuntimeError("This analyzer is for K5 LONG only.")
    ...
    out_dir = os.path.join(rr, "results", "GS", "k5_long")
    ...
    out_path = os.path.join(out_dir, f"strategy_results_GS_k5_long_{label}_{ts()}.csv")
