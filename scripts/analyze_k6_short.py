...
#
# Output:
#   results/k6_short/strategy_results_k6_short_<UTCSTAMP>.csv
#
# Notes:
...
def worker_eval(args: Tuple[int, str, Dict[str, Any], str]) -> Dict[str, Any]:
    ...
    try:
        ...
        # This matches the intended interface: evaluate_strategy(df, combination, side="short")
        res = evaluate_strategy(price_df, combination, side="short")
...
def main():
    ...
    ap.add_argument("--out-dir", default="results/k6_short", help="Output directory")
    ap.add_argument(
        "--num-procs",
        type=int,
    ...
    out_path = os.path.join(args.out_dir, f"strategy_results_k6_short_{stamp}.csv")
