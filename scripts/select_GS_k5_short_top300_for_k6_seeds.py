...
#
# Select Top-300 K5 SHORT strategies as seeds for K6 SHORT.
# Sort:
#   1) roi_fee_p25 desc
#   2) roi_fee_mean desc
#
# Input:
#   results/GS/k5_short/strategy_results_GS_k5_short_FULL_<ts>.csv
# Output:
#   strategies/GS/k5_short/strategies_GS_k5_short_TOP300_for_k6_seeds_<ts>.csv
#
# Output columns:
...
def parse_args():
    ap = argparse.ArgumentParser(description="Select Top-300 K5 SHORT seeds for K6 SHORT.")
    ap.add_argument(
        "--in_csv",
        default="results/GS/k5_short/strategy_results_GS_k5_short_FULL_2026-01-09_17-04-17.csv",
        help="K5 SHORT FULL results CSV",
    )
...
def main():
    ...
    out_path = os.path.join(args.out_dir, f"strategies_GS_k5_short_TOP{top_n}_for_k6_seeds_{ts}.csv")
