...
#
# Select Top-300 K8 SHORT strategies as seeds for K9 SHORT.
# Sort:
#   1) roi_fee_p25 desc
#   2) roi_fee_mean desc
#
# Input:
#   results/GS/k8_short/strategy_results_GS_k8_short_FULL_<ts>.csv
# Output:
#   strategies/GS/k8_short/strategies_GS_k8_short_TOP300_for_k9_seeds_<ts>.csv
#
# Output columns:
...
def parse_args():
    ap = argparse.ArgumentParser(description="Select Top-300 K8 SHORT seeds for K9 SHORT.")
    ap.add_argument(
        "--in_csv",
        default="results/GS/k8_short/strategy_results_GS_k8_short_FULL_2026-01-09_17-39-39.csv",
        help="K8 SHORT FULL results CSV",
    )
...
def main():
    ...
    out_path = os.path.join(args.out_dir, f"strategies_GS_k8_short_TOP{top_n}_for_k9_seeds_{ts}.csv")
