...
#
# Select Top-300 K4 SHORT strategies as seeds for K5 SHORT.
# Gold-Standard rule:
#   1) roi_fee_p25 desc
#   2) roi_fee_mean desc
#
# Input:
#   results/GS/k4_short/strategy_results_GS_k4_short_FULL_<ts>.csv
# Output (authoritative, single file):
#   strategies/GS/k4_short/strategies_GS_k4_short_TOP300_for_k5_seeds_<ts>.csv
#
# Output columns:
...
def parse_args():
    ap = argparse.ArgumentParser(description="Select Top-300 K4 SHORT seeds for K5 SHORT.")
    ap.add_argument(
        "--in_csv",
        default="results/GS/k4_short/strategy_results_GS_k4_short_FULL_2026-01-09_16-51-33.csv",
        help="K4 SHORT FULL results CSV",
    )
...
def main():
    ...
    out_path = os.path.join(args.out_dir, f"strategies_GS_k4_short_TOP{top_n}_for_k5_seeds_{ts}.csv")
