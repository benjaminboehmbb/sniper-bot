...
#
# Select Top-300 K6 SHORT strategies as seeds for K7 SHORT.
# Sort:
#   1) roi_fee_p25 desc
#   2) roi_fee_mean desc
#
# Input:
#   results/GS/k6_short/strategy_results_GS_k6_short_FULL_<ts>.csv
# Output:
#   strategies/GS/k6_short/strategies_GS_k6_short_TOP300_for_k7_seeds_<ts>.csv
#
# Output columns:
...
def parse_args():
    ap = argparse.ArgumentParser(description="Select Top-300 K6 SHORT seeds for K7 SHORT.")
    ap.add_argument(
        "--in_csv",
        default="results/GS/k6_short/strategy_results_GS_k6_short_FULL_2026-01-09_17-16-17.csv",
        help="K6 SHORT FULL results CSV",
    )
...
def main():
    ...
    out_path = os.path.join(args.out_dir, f"strategies_GS_k6_short_TOP{top_n}_for_k7_seeds_{ts}.csv")
