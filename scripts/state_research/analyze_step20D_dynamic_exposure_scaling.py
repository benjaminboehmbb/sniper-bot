...
def multiplier_from_streaks(risk_series):
    high_030 = 0
    high_050 = 0
    high_070 = 0
    multiplier = 1.0

    for risk in risk_series:
        high_030 = high_030 + 1 if risk > 0.30 else 0
        high_050 = high_050 + 1 if risk > 0.50 else 0
        high_070 = high_070 + 1 if risk > 0.70 else 0
...
for _, trade in trades.iterrows():
    ...
    if len(life_trade) == 0 or len(shadow_trade) == 0:
        ...
        multiplier = multiplier_from_streaks(merged["shadow_risk_score"].tolist())
...
print()
print("---- STEP20D DYNAMIC EXPOSURE SCALING ----")
print("trades:", len(df))
print()
...
out = "reports/step18/step20D_dynamic_exposure_scaling.csv"
